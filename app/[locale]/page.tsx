...
import { Navbar, Logo, FingerprintMark, CTAButton } from "../../components/SiteNavbar";
...
function Footer() {
  ...
  const legalLinks = [
    { label: t("footer_col_legal"), href: href("terms") },
    { label: t("footer_legal_mentions"), href: href("terms") },
    { label: t("footer_gdpr"), href: href("terms", { hash: "#rgpd" }) },
    { label: t("footer_privacy"), href: href("terms", { hash: "#rgpd" }) },
  ];

  const cols = [
    { title: t("footer_col_product"), links: productLinks },
    { title: t("footer_col_company"), links: companyLinks },
    { title: t("footer_col_legal"), links: legalLinks },
  ];
