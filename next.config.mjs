 ...
 *   bootstrap, streaming, runtime scripts) and Tailwind (inline styles).
 ...
 * - upgrade-insecure-requests is prod only — it breaks Safari on
 *   http://localhost during dev because Safari forces HTTPS upgrades.
 */
